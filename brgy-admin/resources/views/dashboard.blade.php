...
<title>Barangay Application System</title>
...
<style type="text/css">
 ...
 .table-title {        
  padding-bottom: 15px;
     background: linear-gradient(40deg,#0D324D,#7F5A83
) !important;
  color: #fff;
  padding: 16px 30px;
...
<div id="mainbox" onclick="openFunction()">&#9776; Open</div>
  <div id="menu" class="sidemenu">
   <a href="dashboard">Manage Request</a>
   <a href="{{ route('history') }}">Transaction History</a>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
      <h2><b>Barangay Request System</b></h2>
     </div>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      @foreach($request as $row)
                        <td id="user_id">{{$row->request_id}}</td>
                        <td id="">{{$row->name}}</td>
                        <td id="">{{$row->address}}</td>
                        <td id="">{{$row->contact}}</td>
                        <td id="">{{$row->request}}</td>
                        <td id="">{{$row->purpose}}</td>
                        <td id="">{{$row->date_requested}}</td>    
                        <td>
                        
                        <a href="#departEmployeeModal" class="depart" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">check_circle</i></a>
